...
<div class="w3-row w3-margin-top">
    <div class="w3-quarter w3-container">
        ...
        <form action='peserta-login-proses.php' method='POST'>
            ...
            <input class= 'w3-input w3-hover-blue w3-pale-blue w3-animate-input' type='text'style="width:70%" name='nokp' 
            ...
            <input class='w3-input w3-hover-blue w3-pale-blue w3-animate-input' type='password'style="width:70%" name='katalaluan'><br>
